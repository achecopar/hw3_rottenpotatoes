...
module NavigationHelpers
  ...
  def path_to(page_name)
    ...
    #ORIGINAL GOOD ONE; DONT KNOW WHY IT DOESNT WORK
    #when /^the Similar Movies page for "(.*)"/ then "/movies/#{Movie.find_by_title($1).id}/similar_movies?search_term=director"
